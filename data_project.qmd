...
- No proper documentation
  - Managed to get an incomplete word document
  - Found json API description
    - Only gives idea of structure, not purpose or use
...
- [Characterise functions GitLab #20](https://gitlab.com/paulrougieux/faostatpackage/-/issues/20)
  
## Consequent work
  
### Function regression  

- Had to repair zip function because of fao search
...
- Used chatGPT to help generate tests.^[[ChatGPTv3 conversation](https://sharegpt.com/c/REwBzY6) 2023-03-28] Gave it code and told it to give me ideas for tests

Documented using `roxygen2` [@Wickham2022], tests written using `testthat` [@Wickham2011]
